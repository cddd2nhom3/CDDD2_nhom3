...
public class FirstFragment extends Activity{
    // URL Address
    String url = "http://careerbuilder.vn/viec-lam/cntt-phan-cung-mang-cntt-phan-mem-c63,1-vi.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) { // TODO Auto-generated method stub
                Intent intent = new Intent(FirstFragment.this,SearchActivity.class);
    ...
    private class _JSOUP extends AsyncTask<Void, Integer, ArrayList<ThuocTinh>> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(FirstFragment.this);
...
//                Log.d("aaa", tieude + "");
        ...
        protected void onPostExecute(ArrayList<ThuocTinh> result) {
            ...
            lvDanhSach = (ListView) findViewById(R.id.lvdanhsach);
            adapter = new MyAdapter(FirstFragment.this,
            ...
            lvDanhSach.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent intent = new Intent(FirstFragment.this,
