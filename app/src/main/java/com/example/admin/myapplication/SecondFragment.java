...
public class SecondFragment extends Activity {
    // URL Address
    String url = "http://careerbuilder.vn/viec-lam/dich-vu-khach-hang-ke-toan-kiem-toan-thong-ke-c12,2,36-vi.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) { // TODO Auto-generated method stub
                Intent intent = new Intent(SecondFragment.this,SearchActivity.class);
    ...
    void getAndUpdateLink() {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                ...
                url = "http://careerbuilder.vn/viec-lam/dich-vu-khach-hang-ke-toan-kiem-toan-thong-ke-c12,2,36-vi.html";
            }
        }
    }
    //loadding prase
    private class _JSOUP extends AsyncTask<Void, Integer, ArrayList<ThuocTinh>> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(SecondFragment.this);
...
//                Log.d("aaa", tieude + "");
        ...
        protected void onPostExecute(ArrayList<ThuocTinh> result) {
            ...
            lvDanhSach = (ListView) findViewById(R.id.lvdanhsach);
            adapter = new MyAdapter(SecondFragment.this,
            ...
            lvDanhSach.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent intent = new Intent(SecondFragment.this,
